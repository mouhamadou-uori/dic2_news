...
class WSDLGenerator {
    public function generate($className, $namespace) {
        ...
        // Début du document WSDL
        echo '<?xml version="1.0" encoding="UTF-8"?>';
        echo '<definitions name="' . $className . '" 
        ...
        // Messages pour les méthodes
        echo '<message name="listUsersRequest">
        ...
        // Port Type
        echo '<portType name="' . $className . 'PortType">
        ...
        // Binding
        echo '<binding name="' . $className . 'Binding" type="tns:' . $className . 'PortType">
